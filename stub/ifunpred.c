...
g7987:
  if (_trace) printf("g7987:\n");
  t6 = (t5 == Type_SingleFloat) ? 1 : 0;

g8000:
  if (_trace) printf("g8000:\n");
  if (t6 == 0)
    goto g7992;
